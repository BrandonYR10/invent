...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/logo_fruti.jpg"))); // NOI18N
        ...
        jLabel4.setText("¿No tienes cuenta?  Al administrador le tendras  que pedir permiso.");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        String pase=new String(Password.getPassword());
        if (username.getText().equals(Usuario) && pase.equals(Contraseña)) {
            Menu P=new Menu();
            P.setVisible(true);
            dispose();
        }else{
