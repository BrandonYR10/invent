...
public class Formulario_Entrada extends javax.swing.JFrame {
Proceso_entrada proceso=new Proceso_entrada ();
...
public void mostrarRegistros(){
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/mercaderiaentradaS.jpg"))); // NOI18N
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/salidamenu.jpg"))); // NOI18N
...
//set obtener valor get mostrar
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
         ...
         //Util_Entrada entrada;
         entrada=new Util_Entrada(id,pro,st,cos);
...
//******************************************************************************************    
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Formulario_Entrada().setVisible(true);
            }
        });
    }
